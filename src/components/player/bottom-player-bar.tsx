...
export function BottomPlayerBar() {
  ...
  return (
    <>
      <footer
        data-player-hidden={false}
        className="border-border bg-background/80 duration-regular ease-standard flex h-20 min-w-0 shrink-0 items-center gap-2 border-t px-2 backdrop-blur-2xl transition-transform data-[player-hidden=true]:translate-y-full sm:gap-4 sm:px-4"
      >
